...
public fn trailing_zeros32(x u32) int {
	if x == u32(0) {
		return 32
	}
	// see comment in trailing_zeros64
...
public fn trailing_zeros64(x u64) int {
	if x == u64(0) {
		return 64
	}
...
public fn ones_count64(x u64) int {
