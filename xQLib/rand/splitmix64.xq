...
*/
public fn new_splitmix64(seed u64) Splitmix64 {
...
*/
[inline] public fn (rng mut Splitmix64) next() u64 {
 ...
 * @return the generated pseudo random number
*/
[inline] public fn (rng mut Splitmix64) bounded_next(bound u64) u64 {
