...
public fn ls(path string) []string {
	...
	// We can also check if the handle is valid instead but using dir_exists
...
public fn get_file_handle(path string) HANDLE {
    mode := 'rb'
...
// Reference: https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-formatmessagea#parameters
const (
