...
public fn (_str string) to_wide() &u16 {
    $if windows {
...
public fn string_from_wide(_wstr &u16) string {
    $if windows {
...
public fn string_from_wide2(_wstr &u16, len int) string {
    $if windows {
